...
export type InverseRelationshipFieldFilterBetweenMarketplaceCollectionAndMarketplaceApp = {
  ...
  anyIn?: InputMaybe<Array<MarketplaceCollectionModelFieldsReferencingMarketplaceAppModel>>;
  /** Filter linking records that do not reference current record in any of the specified fields */
  notIn?: InputMaybe<Array<MarketplaceCollectionModelFieldsReferencingMarketplaceAppModel>>;
};

/** Specifies how to filter linking records */
export type InverseRelationshipFilterBetweenMarketplaceCollectionAndMarketplaceApp = {
  /** Specifies how to filter by linking fields */
  fields?: InputMaybe<InverseRelationshipFieldFilterBetweenMarketplaceCollectionAndMarketplaceApp>;
...
export type MarketplaceAppCategoryModelFilter = {
  AND?: InputMaybe<Array<InputMaybe<MarketplaceAppCategoryModelFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<MarketplaceAppCategoryModelFilter>>>;
...
export enum MarketplaceAppCategoryModelOrderBy {
...
export type MarketplaceAppCategoryRecord = RecordInterface & {
  __typename?: 'MarketplaceAppCategoryRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
export type MarketplaceAppContentRecord = RecordInterface & {
  __typename?: 'MarketplaceAppContentRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
/** Block of type Marketplace App Content (marketplace_app_content) */
export type MarketplaceAppContentRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};


/** Block of type Marketplace App Content (marketplace_app_content) */
export type MarketplaceAppContentRecordBodyArgs = {
  markdown?: InputMaybe<Scalars['Boolean']['input']>;
};

export type MarketplaceAppModelFilter = {
  AND?: InputMaybe<Array<InputMaybe<MarketplaceAppModelFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<MarketplaceAppModelFilter>>>;
  _createdAt?: InputMaybe<CreatedAtFilter>;
  _firstPublishedAt?: InputMaybe<PublishedAtFilter>;
  _isValid?: InputMaybe<BooleanFilter>;
  _publicationScheduledAt?: InputMaybe<PublishedAtFilter>;
...
export enum MarketplaceAppModelOrderBy {
  CreatedAtAsc = '_createdAt_ASC',
  CreatedAtDesc = '_createdAt_DESC',
  FirstPublishedAtAsc = '_firstPublishedAt_ASC',
  FirstPublishedAtDesc = '_firstPublishedAt_DESC',
...
/** Record of type Marketplace App (marketplace_app) */
export type MarketplaceAppRecord = RecordInterface & {
  __typename?: 'MarketplaceAppRecord';
  _allReferencingMarketplaceCollections: Array<MarketplaceCollectionRecord>;
  /** Returns meta information regarding a record collection */
  _allReferencingMarketplaceCollectionsMeta: CollectionMetadata;
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
/** Record of type Marketplace App (marketplace_app) */
export type MarketplaceAppRecord_AllReferencingMarketplaceCollectionsArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  ...
  skip?: InputMaybe<Scalars['IntType']['input']>;
  through?: InputMaybe<InverseRelationshipFilterBetweenMarketplaceCollectionAndMarketplaceApp>;
};


/** Record of type Marketplace App (marketplace_app) */
export type MarketplaceAppRecord_AllReferencingMarketplaceCollectionsMetaArgs = {
  filter?: InputMaybe<MarketplaceCollectionModelFilter>;
  locale?: InputMaybe<SiteLocale>;
  through?: InputMaybe<InverseRelationshipFilterBetweenMarketplaceCollectionAndMarketplaceApp>;
};
...
/** Record of type Marketplace App (marketplace_app) */
export type MarketplaceAppRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};


/** Record of type Marketplace App (marketplace_app) */
export type MarketplaceAppRecordDescriptionArgs = {
  markdown?: InputMaybe<Scalars['Boolean']['input']>;
};

/** Linking fields */
export enum MarketplaceCollectionModelFieldsReferencingMarketplaceAppModel {
  MarketplaceCollectionApps = 'marketplaceCollection_apps'
}
...
export type PlanItemModelValuesField = PlanItemValueYesNoRecord | PlanItemValuesTextRecord;

/** Block of type Plan Item (plan_item) */
export type PlanItemRecord = RecordInterface & {
  __typename?: 'PlanItemRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  values?: Maybe<PlanItemModelValuesField>;
};


/** Block of type Plan Item (plan_item) */
export type PlanItemRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

/** Block of type Plan Item Values Yes/no (plan_item_value_yes_no) */
export type PlanItemValueYesNoRecord = RecordInterface & {
  __typename?: 'PlanItemValueYesNoRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  enterprise: Scalars['BooleanType']['output'];
  id: Scalars['ItemId']['output'];
  plus: Scalars['BooleanType']['output'];
  pro: Scalars['BooleanType']['output'];
};


/** Block of type Plan Item Values Yes/no (plan_item_value_yes_no) */
export type PlanItemValueYesNoRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

/** Block of type Plan Item Values text (plan_item_values_text) */
export type PlanItemValuesTextRecord = RecordInterface & {
  __typename?: 'PlanItemValuesTextRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  enterprise: Scalars['String']['output'];
  id: Scalars['ItemId']['output'];
  plus: Scalars['String']['output'];
  pro: Scalars['String']['output'];
};


/** Block of type Plan Item Values text (plan_item_values_text) */
export type PlanItemValuesTextRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

/** Block of type Plan Section (plan_section) */
export type PlanSectionRecord = RecordInterface & {
  __typename?: 'PlanSectionRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  id: Scalars['ItemId']['output'];
  name: Scalars['String']['output'];
  values: Array<PlanItemRecord>;
};


/** Block of type Plan Section (plan_section) */
export type PlanSectionRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** The query root for this schema */
export type Query_AllMarketplaceAppCategoriesMetaArgs = {
...
/** The query root for this schema */
export type QueryAllMarketplaceAppCategoriesArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<MarketplaceAppCategoryModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
...
/** The query root for this schema */
export type QueryAllMarketplaceAppsArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<MarketplaceAppModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<MarketplaceAppModelOrderBy>>>;
  skip?: InputMaybe<Scalars['IntType']['input']>;
};
...
/** The query root for this schema */
export type QueryMarketplaceAppCategoryArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<MarketplaceAppCategoryModelFilter>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<MarketplaceAppCategoryModelOrderBy>>>;
...
export type RealEstatePageRecord = RecordInterface & {
  __typename?: 'RealEstatePageRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
/** Record of type Real Estate page (real_estate_page) */
export type RealEstatePageRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type MarketplaceAppAttributesFragment = { __typename?: 'MarketplaceAppRecord', id: any, title: string, slug: string, description?: string, logo?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, categories: Array<{ __typename?: 'MarketplaceAppCategoryRecord', id: any, title: string, slug: string }>, heroImage?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, _allReferencingMarketplaceCollections: Array<{ __typename?: 'MarketplaceCollectionRecord', id: any, title: string, slug: string, builtByAurora: any }> };
...
export type MarketplaceAppsSearchQuery = { __typename?: 'Query', allMarketplaceApps: Array<{ __typename?: 'MarketplaceAppRecord', id: any, title: string, slug: string, description?: string, logo?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, categories: Array<{ __typename?: 'MarketplaceAppCategoryRecord', id: any, title: string, slug: string }>, heroImage?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, _allReferencingMarketplaceCollections: Array<{ __typename?: 'MarketplaceCollectionRecord', id: any, title: string, slug: string, builtByAurora: any }> }> };
...
export type MarketplaceAppsQuery = { __typename?: 'Query', allMarketplaceApps: Array<{ __typename?: 'MarketplaceAppRecord', id: any, title: string, slug: string, description?: string, logo?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, categories: Array<{ __typename?: 'MarketplaceAppCategoryRecord', id: any, title: string, slug: string }>, heroImage?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, _allReferencingMarketplaceCollections: Array<{ __typename?: 'MarketplaceCollectionRecord', id: any, title: string, slug: string, builtByAurora: any }> }> };
...
export type MarketplaceCollectionQuery = { __typename?: 'Query', marketplaceCollection?: { __typename?: 'MarketplaceCollectionRecord', id: any, title: string, description?: string, icon?: string, apps: Array<{ __typename?: 'MarketplaceAppRecord', id: any, title: string, slug: string, description?: string, logo?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, categories: Array<{ __typename?: 'MarketplaceAppCategoryRecord', id: any, title: string, slug: string }>, heroImage?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, _allReferencingMarketplaceCollections: Array<{ __typename?: 'MarketplaceCollectionRecord', id: any, title: string, slug: string, builtByAurora: any }> }> } };

export type MarketplaceCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type MarketplaceCollectionsQuery = { __typename?: 'Query', allMarketplaceCollections: Array<{ __typename?: 'MarketplaceCollectionRecord', id: any, title: string, icon?: string, slug: string, homepageDisplay?: string, builtByAurora: any, apps: Array<{ __typename?: 'MarketplaceAppRecord', id: any, title: string, slug: string, description?: string, logo?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, categories: Array<{ __typename?: 'MarketplaceAppCategoryRecord', id: any, title: string, slug: string }>, heroImage?: { __typename?: 'FileField', id: any, url: string, width?: any, alt?: string, height?: any }, _allReferencingMarketplaceCollections: Array<{ __typename?: 'MarketplaceCollectionRecord', id: any, title: string, slug: string, builtByAurora: any }> }> }> };
...
export const MarketplaceAppDocument = `
  ...
  marketplaceApp(filter: {slug: {eq: $slug}}) {
    ...
    ${ImageAttributesFragmentDoc}`;
export const useMarketplaceAppQuery = <
      TData = MarketplaceAppQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: MarketplaceAppQueryVariables,
      options?: UseQueryOptions<MarketplaceAppQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<MarketplaceAppQuery, TError, TData>(
      ['MarketplaceApp', variables],
      fetcher<MarketplaceAppQuery, MarketplaceAppQueryVariables>(client, MarketplaceAppDocument, variables, headers),
      options
    );
export const MarketplaceAppsMetaDocument = `
    query MarketplaceAppsMeta {
  allMarketplaceApps(first: 100) {
    slug
  }
}
    `;
export const useMarketplaceAppsMetaQuery = <
      TData = MarketplaceAppsMetaQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: MarketplaceAppsMetaQueryVariables,
      options?: UseQueryOptions<MarketplaceAppsMetaQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<MarketplaceAppsMetaQuery, TError, TData>(
      variables === undefined ? ['MarketplaceAppsMeta'] : ['MarketplaceAppsMeta', variables],
...
export const useMarketplaceAppsQuery = <
    ...
    >(
      client: GraphQLClient,
      variables?: MarketplaceAppsQueryVariables,
      options?: UseQueryOptions<MarketplaceAppsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
