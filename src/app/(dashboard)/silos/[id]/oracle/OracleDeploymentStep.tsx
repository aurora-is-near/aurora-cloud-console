...
export const OracleDeploymentStep = ({
  ...
  return (
    <div className="flex flex-row relative">
      <div
        className={clsx(
          "w-10 h-10 rounded-full flex items-center justify-center text-lg text-white font-medium mr-6 mt-6 border border-slate-50 outline outline-8 outline-slate-50 z-10",
      ...
      {connectingLine && (
        <div
          className={clsx(
            "absolute top-16 left-[19px] h-full border border-1 border-slate-200",
