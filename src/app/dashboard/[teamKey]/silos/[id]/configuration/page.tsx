...
const Page = async ({
  ...
  const configItems: ConfigurationItemsCardProps["items"] = [
    {
      term: "Network",
  ...
  if (silo.explorer_url) {
    configItems.push({
      ...
      tooltip:
        "Access a dedicated blockchain explorer for real-time transaction and contract tracking on your chain.",
      showCopyButton: true,
    })
  }
