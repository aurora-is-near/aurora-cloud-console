...
export const Input = <Inputs extends Record<string, unknown>>({
  ...
  <input
    ...
    disabled={disabled}
    className={clsx(
      "block w-full rounded-md border-0 py-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6",
